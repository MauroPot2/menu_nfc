...
class HideButton extends StatelessWidget {
  const HideButton({super.key, required this.drinkData, required this.doc});
    ...
    return IconButton(
      icon: Icon(
        ...
        drinkData['isAvailable'] == false
            ...
            : Icons.visibility,
        color: drinkData['isAvailable'] == false ? Colors.grey : Colors.blue,
      ),
      onPressed: () {
        // Invertiamo lo stato: se è null o true diventa false, e viceversa
        bool statoAttuale = drinkData['isAvailable'] ?? true;
        doc.reference.update({'isAvailable': !statoAttuale});
      },
